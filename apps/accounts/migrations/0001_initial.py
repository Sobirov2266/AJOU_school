    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passport_id', models.CharField(blank=True, max_length=20, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passport_id', models.CharField(blank=True, max_length=20, null=True, unique=True, verbose_name='Passport yoki guvohnoma ID')),
                ...
                ('school_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='students', to='academic.schoolclass')),
